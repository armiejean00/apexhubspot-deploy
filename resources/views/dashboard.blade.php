<x-layout :cssPaths="$cssPaths" :title="$title">
    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="p-8 order bg-white bg-opacity-25 rounded-lg">
    <div class="head text-center">
        <p class="text-3xl">Welcome, {{ auth()->user()->first_name }} {{ auth()->user()->last_name }}!</p><br>
        <p class="text-xl mb-6">Your desk booking journey starts here</p>
        <a href="/desks/available" class="text-white text-xl px-6 py-2 rounded-md inline-block" style="background-color: #8A2BE2; width: 180px;">Book now</a>
        <a href="/guide" class="text-blue-500 block mt-4" style="text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Click me for Tutorial!</a>
        </div>
</div>

    ...
    <section id="content">
        ...
        <section class="body-font relative">
            <div class="container px-5 py-24 mx-auto">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4">Report Hot Desking Issues</h1>
                <p class="text-lg">Please provide details about the hot desking issues you encountered.</p>
                </div>
                            ...
                            <div class="p-2 w-full">
                                <div class="relative">
                                    ...
                                    <select id="issue" name="issue"
                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
